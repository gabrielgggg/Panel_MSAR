...
\item Otherwise GDP is NSA. Productivity is then seasonally adjusted with
statsmodels SARIMAX when the spell is long enough.
\end{itemize}

\paragraph{SARIMAX on NSA countries.}
NSA GDP, and typically NSA employment, leave seasonality in the productivity
ratio. For those countries, if there are at least 12 observations covering
...
\texttt{NSA}. In the current vintage that is Ghana (11), El Salvador (10),
Belarus (6), Bangladesh (4), Botswana (2), and Mozambique (2).
